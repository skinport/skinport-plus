  ...
  return (
    <div className="h-screen flex justify-center items-center px-8">
      <div className="flex flex-col items-center gap-4 text-center max-w-3xl">
        ...
        <a
          href="https://skinport.com"
          className="rounded uppercase font-bold tracking-widest text-xs transition text-white outline-none bg-blue hover:bg-blue-dark py-2 px-4"
        >
          Continue to Skinport.com
        </a>
      </div>
    </div>
  );
